...
class LevelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create level" do
    assert_difference('Level.count') do
      post levels_url, params: { level: { datatime: @level.datatime, depth: @level.depth, quality: @level.quality, serialno: @level.serialno, siteid: @level.siteid } }
    end
  ...
  test "should update level" do
    patch level_url(@level), params: { level: { datatime: @level.datatime, depth: @level.depth, quality: @level.quality, serialno: @level.serialno, siteid: @level.siteid } }
